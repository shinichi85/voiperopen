 ...
 */
if (!isset($old_error_reporting)) {    error_reporting(E_ALL);
 ...
 */
/* $cfg['PmaAbsoluteUri'] = 'http://192.168.0.21/phpmyadmin/'; */
...
$cfg['Servers'][$i]['password']      = 'voiper';    // MySQL password (only needed
