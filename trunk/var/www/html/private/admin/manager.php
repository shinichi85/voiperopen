...
<!-- right side menu -->
<div class="rnav">
    <li><a id="<?php echo ($managerdisplay=='' ? 'current':'') ?>" href="config.php?mode=settings&amp;display=<?php echo urlencode($dispnum)?>"><?php echo _("Add Manager")?></a></li>
<?php
if (isset($managers)) {
...
?>
	...
	<tr>
		<td><a href="#" class="info"><?php echo _("Deny:")?><span><?php echo _("If you want to deny many hosts or networks, use & char as separator.<br>Example:<br>192.168.1.0/255.255.255.0<br>10.0.0.0/255.0.0.0")?></span></a></td>
