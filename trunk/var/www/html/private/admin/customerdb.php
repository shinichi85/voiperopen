...
//$display = isset($_REQUEST['display'])?$_REQUEST['display']:'2';
//$type = isset($_REQUEST['type'])?$_REQUEST['type']:'tools';
...
$state = isset($_REQUEST['state'])?$_REQUEST['state']:'Italy';
...
echo "<form name=\"addNew\" action=\"config.php?display=2&mode=tools\" method=\"post\" onsubmit=\"return addNew_onsubmit();\">";
...
echo "<input type=radio checked name=\"sipbtn\" onclick=\"switchit_sip();return true;\"> <a href=\"#\" class=\"info\">Sip Account\n";
echo "<span>Sip Account (must have this or a did tied to the account)</span></a>\n";
echo "</td><td>\n";
...
//Did
echo "<tr><td align=left>\n";
echo "<input type=radio name=\"didbtn\" onclick=\"switchit_did();return true;\"> <a href=\"#\" class=\"info\">DID Number\n";
echo "<span>DID Number (must have this or sip tied to the account)</span></a>\n";
echo "</td><td>\n";
...
echo "</td>";
echo "<td>";
echo "<input size=\"25\" type=text name=\"name\" value=\"$name\">\n";
echo "</td></tr>\n";
...
echo "</td><td>\n";
echo "<input size=\"25\" type=text name=\"addr1\" value=\"$addr1\"\n";
echo "</td></tr>\n";
...
echo "</td><td>\n";
echo "<input size=\"25\" type=text name=\"addr2\" value=\"$addr2\">\n";
echo "</td><tr>\n";
...
echo "</td><td>\n";
echo "<input size=\"25\" type=text name=\"ip\" value=\"$ip\">\n";
echo "</td></tr>\n";
...
echo "</td><td>\n";
echo "<input size=\"25\" name=\"email\" value=\"$email\">\n";
echo "</td></tr>\n";
...
?>
<tr><td></td><td><br><input name="Submit" type="submit" Value="Submit Changes"></td></tr></table>
