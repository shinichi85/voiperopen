 ...
 *
 * $Id: phplib_oracle.php,v 1.2 2005/03/13 20:34:06 rcourtna Exp $
 *
 */ 
...
## replaced Home with Host for consistancy
  var $Host = "";
...
#        return();
  ...
  function currentid($seq_name)
  {
      ...
      @ora_parse($Query_ID,"SELECT $seq_name.CURRVAL FROM DUAL");
      @ora_exec($Query_ID))
      if (@ora_fetch($Query_ID) ) {
        $current_id =  ora_getcolumn($Query_ID, 0);
      }
      else {
        $current_id = 0;
      }
