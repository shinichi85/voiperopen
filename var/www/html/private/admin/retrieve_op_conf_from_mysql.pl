...
open( ZAPATA, "<$zapataconf" ) or die "Cannot create/overwrite extensions file: $zapataconf (!$)\n";
...
$op_conf = "/var/www/html/public/panel/op_buttons_additional.cfg";
...
open( EXTEN, ">$op_conf" ) or die "Cannot create/overwrite extensions file: $op_conf (!$)\n";
