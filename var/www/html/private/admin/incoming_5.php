...
$globalfields = array(array($_REQUEST['INCOMING'],'INCOMING_5'),
                        array($interval[0][0],'REGTIME_5'),
                        array($interval[0][1],'REGDAYS_5'),
                        array($interval[0][2],'REGMONTHS_5'),
                        array($interval[1][0],'REGTIME2_5'),
                        array($interval[1][1],'REGDAYS2_5'),
                        array($interval[1][2],'REGMONTHS2_5'),
                        array($interval[2][0],'REGTIME3_5'),
                        array($interval[2][1],'REGDAYS3_5'),
                        array($interval[2][2],'REGMONTHS3_5'),
                        array($interval[3][0],'REGTIME4_5'),
                        array($interval[3][1],'REGDAYS4_5'),
                        array($interval[3][2],'REGMONTHS4_5'),
                        array($_REQUEST['INCOMING_DESC'],'INCOMING_DESC_5'),
                        array($_REQUEST['AFTER_INCOMING'],'AFTER_INCOMING_5'),
                        array($_REQUEST['HOLIDAY_INCOMING'],'HOLIDAY_INCOMING_5'),
                        array($_REQUEST['IN_OVERRIDE'],'IN_OVERRIDE_5'));
...
foreach ($globals as $global) {
    ...
    $ReadForceIncomingHours = ReadForceIncomingHours(6);
...
echo "<h3>"._("Incoming Calls <font class=\"contextcolor\">#6</font> (context: <font class=\"contextcolor\"> from-trunk-5</font>):")."</h3>";
?>
...
<?php
        ...
        for($i=0;$i<24;$i++) {
            ...
            if(strlen($REGTIME_5) > 1) {
                $fixora = preg_split('/[:-]/',$REGTIME_5);
                if($fixora[0] == $i) {
                    echo 'SELECTED';
                }
            }
...
<?php
        ...
        for($i=0;$i<60;$i+=5) {
            ...
            if(strlen($REGTIME_5) > 1) {
                $fixminuti = preg_split('/[:-]/',$REGTIME_5);
                if($fixminuti[1] == $i) {
                    echo 'SELECTED';
                }
            }
...
<?php
        foreach($giorni as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGDAYS_5,0,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
...
<?php
        foreach($mesi as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGMONTHS_5,0,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
...
<?php
        foreach($giorni as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGDAYS_5,4,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
        }
?>
...
<?php
        foreach($mesi as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGMONTHS_5,4,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
        }
?>
    </select>
...
<?php
    echo '<td width="25%">All Hours <input onFocus="this.blur()" type="checkbox" name="ore_tutti[0]" value="1" '.($REGTIME_5 == '*' ? 'CHECKED' : '').'>'."</td>";
    echo '<td width="25%">All Days <input onFocus="this.blur()" type="checkbox" name="giorni_tutti[0]" value="1" '.($REGDAYS_5 == '*' ? 'CHECKED' : '').'>'."</td>";
    echo '<td width="30%">All Months <input onFocus="this.blur()" type="checkbox" name="mesi_tutti[0]" value="1" '.($REGMONTHS_5 == '*' ? 'CHECKED' : '').'>'."</td>";
?>
    </tr>
    </table>
</td></tr>
...
<?php
        ...
        for($i=0;$i<24;$i++) {
            ...
            if(strlen($REGTIME2_5) > 1) {
                $fixora = preg_split('/[:-]/',$REGTIME2_5);
                if($fixora[0] == $i) {
                    echo 'SELECTED';
                }
            }
...
<?php
        ...
        for($i=0;$i<60;$i+=5) {
            ...
            if(strlen($REGTIME2_5) > 1) {
                $fixminuti = preg_split('/[:-]/',$REGTIME2_5);
                if($fixminuti[1] == $i) {
                    echo 'SELECTED';
                }
            }
...
<?php
        foreach($giorni as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGDAYS2_5,0,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
...
<?php
        foreach($mesi as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGMONTHS2_5,0,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
...
<?php
        foreach($giorni as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGDAYS2_5,4,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
        }
?>
...
<?php
        foreach($mesi as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGMONTHS2_5,4,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
        }
?>
    </select>
...
<?php
    echo '<td width="25%">All Hours <input onFocus="this.blur()" type="checkbox" name="ore_tutti[1]" value="1" '.($REGTIME2_5 == '*' ? 'CHECKED' : '').'>'."</td>";
    echo '<td width="25%">All Days <input onFocus="this.blur()" type="checkbox" name="giorni_tutti[1]" value="1" '.($REGDAYS2_5 == '*' ? 'CHECKED' : '').'>'."</td>";
    echo '<td width="30%">All Months <input onFocus="this.blur()" type="checkbox" name="mesi_tutti[1]" value="1" '.($REGMONTHS2_5 == '*' ? 'CHECKED' : '').'>'."</td>";
?>
    </tr>
    </table>
</td></tr>
...
<?php
        ...
        for($i=0;$i<24;$i++) {
            ...
            if(strlen($REGTIME3_5) > 1) {
                $fixora = preg_split('/[:-]/',$REGTIME3_5);
                if($fixora[0] == $i) {
                    echo 'SELECTED';
                }
            }
...
<?php
        ...
        for($i=0;$i<60;$i+=5) {
            ...
            if(strlen($REGTIME3_5) > 1) {
                $fixminuti = preg_split('/[:-]/',$REGTIME3_5);
                if($fixminuti[1] == $i) {
                    echo 'SELECTED';
                }
            }
...
<?php
        foreach($giorni as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGDAYS3_5,0,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
...
<?php
        foreach($mesi as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGMONTHS3_5,0,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
...
<?php
        foreach($giorni as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGDAYS3_5,4,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
        }
?>
...
<?php
        foreach($mesi as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGMONTHS3_5,4,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
        }
?>
    </select>
...
<?php
    echo '<td width="25%">All Hours <input onFocus="this.blur()" type="checkbox" name="ore_tutti[2]" value="1" '.($REGTIME3_5 == '*' ? 'CHECKED' : '').'>'."</td>";
    echo '<td width="25%">All Days <input onFocus="this.blur()" type="checkbox" name="giorni_tutti[2]" value="1" '.($REGDAYS3_5 == '*' ? 'CHECKED' : '').'>'."</td>";
    echo '<td width="30%">All Months <input onFocus="this.blur()" type="checkbox" name="mesi_tutti[2]" value="1" '.($REGMONTHS3_5 == '*' ? 'CHECKED' : '').'>'."</td>";
?>
    </tr>
    </table>
</td></tr>
...
<?php
        ...
        for($i=0;$i<24;$i++) {
            ...
            if(strlen($REGTIME4_5) > 1) {
                $fixora = preg_split('/[:-]/',$REGTIME4_5);
                if($fixora[0] == $i) {
                    echo 'SELECTED';
                }
            }
...
<?php
        ...
        for($i=0;$i<60;$i+=5) {
            ...
            if(strlen($REGTIME4_5) > 1) {
                $fixminuti = preg_split('/[:-]/',$REGTIME4_5);
                if($fixminuti[1] == $i) {
                    echo 'SELECTED';
                }
            }
...
<?php
        foreach($giorni as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGDAYS4_5,0,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
...
<?php
        foreach($mesi as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGMONTHS4_5,0,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
...
<?php
        foreach($giorni as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGDAYS4_5,4,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
        }
?>
...
<?php
        foreach($mesi as $k => $v) {
            ...
            echo '<option value="'.$k.'" '.(substr($REGMONTHS4_5,4,3) == $k ? 'SELECTED' : '').'>'.$v."</option>";
        }
?>
    </select>
...
<?php
    echo '<td width="25%">All Hours <input onFocus="this.blur()" type="checkbox" name="ore_tutti[3]" value="1" '.($REGTIME4_5 == '*' ? 'CHECKED' : '').'>'."</td>";
    echo '<td width="25%">All Days <input onFocus="this.blur()" type="checkbox" name="giorni_tutti[3]" value="1" '.($REGDAYS4_5 == '*' ? 'CHECKED' : '').'>'."</td>";
    echo '<td width="30%">All Months <input onFocus="this.blur()" type="checkbox" name="mesi_tutti[3]" value="1" '.($REGMONTHS4_5 == '*' ? 'CHECKED' : '').'>'."</td>";
?>
    </tr>
    </table>
</td></tr>
...
<tr><td><h5><?php echo _("incoming call name:")?></h5></td></tr>
    <tr>
        ...
        <input type="text" name="INCOMING_DESC" size="20" maxlength="20" value="<?php echo (isset($INCOMING_DESC_5) ? htmlentities($INCOMING_DESC_5) : ''); ?>"></td>
    </tr>
<tr><td>&nbsp;</td></tr>
</table>
<table width="99%" border="0" cellpadding="1" cellspacing="2">
...
<table width="99%" border="0" cellpadding="1" cellspacing="2">
<tr><td>
    <input type="radio" onFocus="this.blur()" name="in_indicate" value="ivr" onclick="javascript:document.incoming.INCOMING.value=document.incoming.INCOMING_IVR.options[document.incoming.INCOMING_IVR.options.selectedIndex].value;" onkeypress="javascript:if (event.keyCode == 0 || (document.all && event.keyCode == 13)) document.incoming.INCOMING.value=document.incoming.INCOMING_IVR.options[document.incoming.INCOMING_IVR.options.selectedIndex].value;" <?php  echo strpos($INCOMING_5,'aa_') === false ? '' : 'CHECKED=CHECKED';?>/> <?php echo _("Digital Receptionist:")?>
    <input type="hidden" name="INCOMING" value="<?php  echo $INCOMING_5; ?>">
...
<?php
    if (isset($unique_aas)) {
        foreach ($unique_aas as $unique_aa) {
            ...
            echo '<option value="aa_'.$menu_num.'" '.($INCOMING_5 == 'aa_'.$menu_num ? 'SELECTED' : '').'>'.($menu_name ? $menu_name : _("Menu #").$menu_num)."</option>\n";
        }
    }
?>
    </select></td></tr>
<tr><td>
    <input type="radio" onFocus="this.blur()" name="in_indicate" value="extension" onclick="javascript:document.incoming.INCOMING.value=document.incoming.INCOMING_EXTEN.options[document.incoming.INCOMING_EXTEN.options.selectedIndex].value;" onkeypress="javascript:if (event.keyCode == 0 || (document.all && event.keyCode == 13)) document.incoming.INCOMING.value=document.incoming.INCOMING_EXTEN.options[document.incoming.INCOMING_EXTEN.options.selectedIndex].value;"  <?php  echo strpos($INCOMING_5,'EXT') === false ? '' : 'CHECKED=CHECKED';?>/> <?php echo _("Extension:")?>
...
<?php
    if (isset($extens)) {
        foreach ($extens as $exten) {
            echo '<option value="EXT-'.$exten[0].'" '.($INCOMING_5 == 'EXT-'.$exten[0] ? 'SELECTED' : '').'>'.$exten[1]."</option>\n";
        }
    }
?>
    </select></td></tr>
<tr><td>
    <input type="radio" onFocus="this.blur()" name="in_indicate" value="group" onclick="javascript:document.incoming.INCOMING.value=document.incoming.INCOMING_GRP.options[document.incoming.INCOMING_GRP.options.selectedIndex].value;" onkeypress="javascript:if (event.keyCode == 0 || (document.all && event.keyCode == 13)) document.incoming.INCOMING.value=document.incoming.INCOMING_GRP.options[document.incoming.INCOMING_GRP.options.selectedIndex].value;" <?php  echo strpos($INCOMING_5,'GR') === false ? '' : 'CHECKED=CHECKED';?>/> <?php echo _("Ring Group:")?>
...
<?php
    if (isset($gresults)) {
        foreach ($gresults as $gresult) {
            echo '<option value="GRP-'.$gresult[0].'" '.($INCOMING_5 == 'GRP-'.$gresult[0] ? 'SELECTED' : '').'>'.$gresult[0].':'.$gresult[1]."</option>\n";
        }
    }
?>
    </select></td></tr>
<tr><td>
    <input type="radio" onFocus="this.blur()" name="in_indicate" value="queue" onclick="javascript:document.incoming.INCOMING.value=document.incoming.INCOMING_QUEUE.options[document.incoming.INCOMING_QUEUE.options.selectedIndex].value;" onkeypress="javascript:if (event.keyCode == 0 || (document.all && event.keyCode == 13)) document.incoming.INCOMING.value=document.incoming.INCOMING_QUEUE.options[document.incoming.INCOMING_QUEUE.options.selectedIndex].value;" <?php  echo strpos($INCOMING_5,'QUE') === false ? '' : 'CHECKED=CHECKED';?>/> <?php echo _("Queue:")?>
...
<?php
    if (isset($queues)) {
        foreach ($queues as $queue) {
            echo '<option value="QUE-'.$queue[0].'" '.($INCOMING_5 == 'QUE-'.$queue[0] ? 'SELECTED' : '').'>'.$queue[0].':'.$queue[1]."</option>\n";
        }
    }
?>
    </select></td></tr>
...
<tr><td>
    <input type="radio" onFocus="this.blur()" name="in_indicate" value="miscdest" onclick="javascript:document.incoming.INCOMING.value=document.incoming.INCOMING_MISC.options[document.incoming.INCOMING_MISC.options.selectedIndex].value;" onkeypress="javascript:if (event.keyCode == 0 || (document.all && event.keyCode == 13)) document.incoming.INCOMING.value=document.incoming.INCOMING_MISC.options[document.incoming.INCOMING_MISC.options.selectedIndex].value;" <?php  echo strpos($INCOMING_5,'MIS') === false ? '' : 'CHECKED=CHECKED';?>/> <?php echo _("Misc Destinations:")?>
...
<?php
    if (isset($miscs)) {
        foreach ($miscs as $misc) {
            echo '<option value="MIS-'.$misc[0].'" '.($INCOMING_5 == 'MIS-'.$misc[0] ? 'SELECTED' : '').'>'.$misc[0].':'.$misc[1]."</option>\n";
        }
    }
?>
    </select></td></tr>
...
<tr><td>
    <input type="radio" onFocus="this.blur()" name="in_indicate" value="dialext"<?php  echo strpos($INCOMING_5,'DIALEXT') === false ? '' : 'CHECKED=CHECKED';?>/> <a href="#" class="info">Custom number to Dial<span>You can include an extension on a remote system, or an external number (Outbound Routing must contain a valid route for external numbers)</span></a>:
    ...
    <?php
            echo 'value="'.(strpos($INCOMING_5,'DIALEXT') === false ? '' : substr($INCOMING_5,8)).'"/>';
    ?>
...
<?php
    if (isset($queues)) {
        foreach ($queues as $queue) {
            echo '<option value="QUE-'.$queue[0].'" '.($AFTER_INCOMING_5 == 'QUE-'.$queue[0] ? 'SELECTED' : '').'>'.$queue[0].':'.$queue[1]."</option>\n";
        }
    }
?>
    </select></td></tr>
...
<?php
    if (isset($miscs)) {
        foreach ($miscs as $misc) {
            echo '<option value="MIS-'.$misc[0].'" '.($AFTER_INCOMING_5 == 'MIS-'.$misc[0] ? 'SELECTED' : '').'>'.$misc[0].':'.$misc[1]."</option>\n";
        }
    }
?>
    </select></td></tr>
...
<tr><td>
    <input type="radio" onFocus="this.blur()" name="after_in_indicate" value="dialext"<?php  echo strpos($AFTER_INCOMING_5,'DIALEXT') === false ? '' : 'CHECKED=CHECKED';?>/> <a href="#" class="info">Custom number to Dial<span>You can include an extension on a remote system, or an external number (Outbound Routing must contain a valid route for external numbers)</span></a>:
    ...
    <?php
            echo 'value="'.(strpos($AFTER_INCOMING_5,'DIALEXT') === false ? '' : substr($AFTER_INCOMING_5,8)).'"/>';
    ?>

</td></tr>

<tr><td>
    <input type="radio" onFocus="this.blur()" name="after_in_indicate" value="dialfax" onclick="javascript:if (document.incoming.after_in_indicate[6].checked) document.incoming.AFTER_INCOMING.value=[document.incoming.AFTER_INCOMING_DIALFAX.value];"<?php  echo strpos($AFTER_INCOMING_5,'DIALFAX-666') === false ? '' : 'CHECKED=CHECKED';?>/> <a href="#" class="info">Dial native Fax<span>Dial into a fax machine (You MUST configure the email to fax settings in General Settings section)</span></a>
...
<table width="99%" border="0" cellpadding="1" cellspacing="2">
<tr><td>
    <input type="radio" onFocus="this.blur()" name="holiday_in_indicate" value="ivr" onclick="javascript:document.incoming.HOLIDAY_INCOMING.value=document.incoming.HOLIDAY_INCOMING_IVR.options[document.incoming.HOLIDAY_INCOMING_IVR.options.selectedIndex].value;" onkeypress="javascript:if (event.keyCode == 0 || (document.all && event.keyCode == 13)) document.incoming.HOLIDAY_INCOMING.value=document.incoming.HOLIDAY_INCOMING_IVR.options[document.incoming.HOLIDAY_INCOMING_IVR.options.selectedIndex].value;" <?php  echo strpos($HOLIDAY_INCOMING_5,'aa_') === false ? '' : 'CHECKED=CHECKED';?>/> <?php echo _("Digital Receptionist:")?>
    <input type="hidden" name="HOLIDAY_INCOMING" value="<?php  echo $HOLIDAY_INCOMING_5; ?>">
...
<?php
    if (isset($unique_aas)) {
        foreach ($unique_aas as $unique_aa) {
            $menu_num = substr($unique_aa[0],3);
            $menu_name = $unique_aa[1];
            echo '<option value="aa_'.$menu_num.'" '.($HOLIDAY_INCOMING_5 == 'aa_'.$menu_num ? 'SELECTED' : '').'>'.($menu_name ? $menu_name : _("Menu #").$menu_num)."</option>\n";
        }
    }
?>
    </select></td></tr>
<tr><td>
    <input type="radio" onFocus="this.blur()" name="holiday_in_indicate" value="extension" onclick="javascript:document.incoming.HOLIDAY_INCOMING.value=document.incoming.HOLIDAY_INCOMING_EXTEN.options[document.incoming.HOLIDAY_INCOMING_EXTEN.options.selectedIndex].value;" onkeypress="javascript:if (event.keyCode == 0 || (document.all && event.keyCode == 13)) document.incoming.HOLIDAY_INCOMING.value=document.incoming.HOLIDAY_INCOMING_EXTEN.options[document.incoming.HOLIDAY_INCOMING_EXTEN.options.selectedIndex].value;" <?php  echo strpos($HOLIDAY_INCOMING_5,'EXT') === false ? '' : 'CHECKED=CHECKED';?>/> <?php echo _("Extension:")?>
...
<?php
    if (isset($gresults)) {
        foreach ($gresults as $gresult) {
            echo '<option value="GRP-'.$gresult[0].'" '.($HOLIDAY_INCOMING_5 == 'GRP-'.$gresult[0] ? 'SELECTED' : '').'>'.$gresult[0].':'.$gresult[1]."</option>\n";
            }
    }
?>
    </select></td></tr>
<tr><td>
    <input type="radio" onFocus="this.blur()" name="holiday_in_indicate" value="queue" onclick="javascript:document.incoming.HOLIDAY_INCOMING.value=document.incoming.HOLIDAY_INCOMING_QUEUE.options[document.incoming.HOLIDAY_INCOMING_QUEUE.options.selectedIndex].value;" onkeypress="javascript:if (event.keyCode == 0 || (document.all && event.keyCode == 13)) document.incoming.HOLIDAY_INCOMING.value=document.incoming.HOLIDAY_INCOMING_QUEUE.options[document.incoming.HOLIDAY_INCOMING_QUEUE.options.selectedIndex].value;" <?php  echo strpos($HOLIDAY_INCOMING_5,'QUE') === false ? '' : 'CHECKED=CHECKED';?>/> <?php echo _("Queue:")?>
...
<?php
    if (isset($queues)) {
        foreach ($queues as $queue) {
            echo '<option value="QUE-'.$queue[0].'" '.($HOLIDAY_INCOMING_5 == 'QUE-'.$queue[0] ? 'SELECTED' : '').'>'.$queue[0].':'.$queue[1]."</option>\n";
        }
    }
?>
    </select></td></tr>
...
<tr><td>
    <input type="radio" onFocus="this.blur()" name="holiday_in_indicate" value="miscdest" onclick="javascript:document.incoming.HOLIDAY_INCOMING.value=document.incoming.HOLIDAY_INCOMING_MISC.options[document.incoming.HOLIDAY_INCOMING_MISC.options.selectedIndex].value;" onkeypress="javascript:if (event.keyCode == 0 || (document.all && event.keyCode == 13)) document.incoming.HOLIDAY_INCOMING.value=document.incoming.HOLIDAY_INCOMING_MISC.options[document.incoming.HOLIDAY_INCOMING_MISC.options.selectedIndex].value;" <?php  echo strpos($HOLIDAY_INCOMING_5,'MIS') === false ? '' : 'CHECKED=CHECKED';?>/> <?php echo _("Misc Destinations:")?>
...
<?php
    if (isset($miscs)) {
        foreach ($miscs as $misc) {
            echo '<option value="MIS-'.$misc[0].'" '.($HOLIDAY_INCOMING_5 == 'MIS-'.$misc[0] ? 'SELECTED' : '').'>'.$misc[0].':'.$misc[1]."</option>\n";
        }
    }
?>
    </select></td></tr>
...
<tr><td>
    <input type="radio" onFocus="this.blur()" name="holiday_in_indicate" value="dialext"<?php  echo strpos($HOLIDAY_INCOMING_5,'DIALEXT') === false ? '' : 'CHECKED=CHECKED';?>/> <a href="#" class="info">Custom number to Dial<span>You can include an extension on a remote system, or an external number (Outbound Routing must contain a valid route for external numbers)</span></a>:
    ...
    <?php
            echo 'value="'.(strpos($HOLIDAY_INCOMING_5,'DIALEXT') === false ? '' : substr($HOLIDAY_INCOMING_5,8)).'"/>';
    ?>
...
<?
    if ($ReadForceIncomingHours != "none") {
        ...
        $IN_OVERRIDE_5 = $ReadForceIncomingHours;

    }
?>

<tr><td>
    <input type="radio" onFocus="this.blur()" name="IN_OVERRIDE" value="none" <?php  echo $IN_OVERRIDE_5 == 'none' ? 'CHECKED=CHECKED' : 'CHECKED' ?>> <?php echo _("No override (obey the above settings). Day & Night *60")?><br>
</td></tr>
<tr><td>
    <input type="radio" onFocus="this.blur()" name="IN_OVERRIDE" value="forcereghours"<?php  echo $IN_OVERRIDE_5 == 'forcereghours' ? 'CHECKED=CHECKED' : '' ?>> <a href="#" class="info"><?php echo _("Force regular hours")?><span><?php echo _("Select this box if you would like to force the above regular hours setting to always take effect.<br><br>  This is useful for occasions when your office needs to remain open after-hours. (ie: open late on Thursday, or open all day on Sunday). Day & Night *60")?></span></a><br>
</td></tr>
<tr><td>
    <input type="radio" onFocus="this.blur()" name="IN_OVERRIDE" value="forceafthours"<?php  echo $IN_OVERRIDE_5 == 'forceafthours' ? 'CHECKED=CHECKED' : '' ?>> <a href="#" class="info"><?php echo _("Force after hours")?><span><?php echo _("Select this box if you would like to force the above after hours setting to always take effect.<br><br>  This is useful for holidays that fall in the 'regular hours' range above (ie: a holiday Monday). Day & Night *60")?></span></a>
</td></tr>
<tr><td>
    <input type="radio" onFocus="this.blur()" name="IN_OVERRIDE" value="forceholiday"<?php  echo $IN_OVERRIDE_5 == 'forceholiday' ? 'CHECKED=CHECKED' : '' ?>> <a href="#" class="info"><?php echo _("Force holiday")?><span><?php echo _("Select this box if you would like to force the above after hours setting to always take effect.). Day & Night *60")?></span></a>
</td></tr>
