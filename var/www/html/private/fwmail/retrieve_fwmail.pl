...
$fwmail_table_name = "fwmail";
$fwmail_conf = "/root/.forward";
...
open EXTEN, ">$fwmail_conf" or die "Cannot create/overwrite .forward file: $fwmail_conf\n";

$dbh = DBI->connect("dbi:mysql:dbname=$database;host=$hostname", "$username", "$password");
$statement = "SELECT * from $fwmail_table_name";
